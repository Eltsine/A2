...
import azimut.config.audit.AuditEventConverter;
import azimut.domain.PersistentAuditEvent;
...
import static azimut.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
