...
export class FormateurComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.formateurService
      ...
      .subscribe(
        (res: HttpResponse<IFormateur[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFormateurs(): void {
    this.eventSubscriber = this.eventManager.subscribe('formateurListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFormateur[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
